...
int main(int argc, char** argv)
{
	...
	reader.read<pcl::PointXYZRGB>("./level7/1234kinectcenter191017_225_2_ten_deletefloor8.pcd", *cloud);
	...
	sor.setStddevMulThresh(2);                      //设置判断是否为离群点的阀值
	...
	writer.write<pcl::PointXYZRGB>("./level7/1234kinectcenter191017_225_2_ten_deletefloor8_statisticalOutlierRemoval.pcd", *cloud_filtered, false);//去除离群点后的点
