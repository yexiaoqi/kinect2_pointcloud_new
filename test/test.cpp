...
int main()
{
	...
	string input_filename = "C:/vsprojects/test/test/kinectcloud190519.pcd";
	string output_filename = "C:/vsprojects/test/test/kinectcloud190519.ply";
...
int main(int argc, char* argv[])
{
	...
	while (!viewer->wasStopped()) {
		...
		//pcl::io::savePCDFileASCII("kinectcloud190519.pcd", *cloud);
		//if (count == 0)
		//{
		//	pcl::PLYWriter writer;
		//	writer.write("kinectcloud190519.ply", *cloud);
